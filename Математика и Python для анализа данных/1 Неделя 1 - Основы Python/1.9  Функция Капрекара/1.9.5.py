...
# Оказывается, существуют ещё числа, аналогичные числу Капрекара 6174 (трёх- и шестизначные).
#
...
# (это критично, т.к. потом мы будем составлять из этих цифр снова числа). Порядок цифр в ответе не важен.
#
#
#
